"""
Django settings for restless_cell_41556 project.
...
ROOT_URLCONF = 'restless_cell_41556.urls'
...
WSGI_APPLICATION = 'restless_cell_41556.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_cell_41556 API",
    "DESCRIPTION": "API documentation for restless_cell_41556 App",
    "VERSION": "v1",
}
